...
const WriterBook = (props) => (
  <tr>
    <td>{props.book.book_title}</td>
    <td>{props.book.book_author}</td>
    <td>{props.book.book_publishdate}</td>
    <td>
      <Link to={"/writer/read/" + props.book._id}> <button type="button"> Read </button> </Link>
      <Link to={"/writer/edit/" + props.book._id}> <button type="button"> Edit </button> </Link>
...
export default class WriterBookList extends Component {
